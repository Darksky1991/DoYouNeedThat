...
-- Item type constants
local LE_ITEM_CLASS_ARMOR, LE_ITEM_CLASS_WEAPON = Enum.ItemClass.Armor, Enum.ItemClass.Weapon
local LE_ITEM_ARMOR_CLOTH, LE_ITEM_ARMOR_LEATHER, LE_ITEM_ARMOR_MAIL = Enum.ItemArmorSubclass.Cloth, Enum.ItemArmorSubclass.Leather, Enum.ItemArmorSubclass.Mail
local LE_ITEM_ARMOR_PLATE, LE_ITEM_ARMOR_GENERIC, LE_ITEM_WEAPON_AXE1H = Enum.ItemArmorSubclass.Plate, Enum.ItemArmorSubclass.Generic, Enum.ItemWeaponSubclass.Axe1H
local LE_ITEM_WEAPON_MACE1H, LE_ITEM_WEAPON_POLEARM, LE_ITEM_WEAPON_SWORD1H = Enum.ItemWeaponSubclass.Mace1H, Enum.ItemWeaponSubclass.Polearm, Enum.ItemWeaponSubclass.Sword1H
local LE_ITEM_WEAPON_MACE2H, LE_ITEM_WEAPON_SWORD2H, LE_ITEM_WEAPON_WARGLAIVE = Enum.ItemWeaponSubclass.Mace2H, Enum.ItemWeaponSubclass.Sword2H, Enum.ItemWeaponSubclass.Warglaive
local LE_ITEM_WEAPON_STAFF, LE_ITEM_WEAPON_UNARMED, LE_ITEM_WEAPON_DAGGER = Enum.ItemWeaponSubclass.Staff, Enum.ItemWeaponSubclass.Unarmed, Enum.ItemWeaponSubclass.Dagger
local LE_ITEM_WEAPON_BOWS, LE_ITEM_WEAPON_CROSSBOW, LE_ITEM_WEAPON_GUNS = Enum.ItemWeaponSubclass.Bows, Enum.ItemWeaponSubclass.Crossbow, Enum.ItemWeaponSubclass.Guns
local LE_ITEM_WEAPON_WAND, LE_ITEM_ARMOR_SHIELD, LE_ITEM_WEAPON_AXE2H = Enum.ItemWeaponSubclass.Wand, Enum.ItemArmorSubclass.Shield, Enum.ItemWeaponSubclass.Axe2H
